...
?>
<div class="row">
    <?php echo $this->Form->create('Aluno', array('action' => 'editar', 'type' => 'file')); ?>
    <div class="col-lg-9">
        <section class="panel">
            <header class="panel-heading clearfix">
              <span class="pull-left"><i class="icon-pencil"></i> <?php echo __('Editar Aluno'); ?></span>
              ...
              <div class="panel-body">
                ...
                <?php  if($aluno['Aluno']['ra'] == $usuarioLogado['usuario']){ ?>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Senha</label>
                    <div class="col-sm-10">
                        <?php echo $this->Html->link(__('<i class="icon-lock"></i> Alterar senha'), array('action' => 'senha', $aluno['Aluno']['id']), array('class' => 'btn btn-warning btn-shadow', 'escape' => false)); ?>
              ...
              <table class="table table-hover personal-task">
                  <tbody>
                    <tr>
                        ...
                        <td><?php echo $this->Time->format('d/m/Y \à\s h:i:s', $aluno['Usuario']['criado']); ?>
                    </tr>

                    <tr>
                        <td><?php echo __('Modificado'); ?></td>
                        <td><?php echo $this->Time->format('d/m/Y \à\s h:i:s', $aluno['Usuario']['modificado']); ?></td>
                    </tr>

                      <tr>
                        <td><?php echo __('Último login'); ?></td>
                        <td><?php echo $this->Time->format('d/m/Y \à\s h:i:s', $aluno['Usuario']['acesso']); ?></td>
                    </tr>
                  </tbody>
              </table>
        </section>

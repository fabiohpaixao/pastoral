<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td style="padding: 20px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
            Você foi cadastrado(a) como <strong><?php echo $grupo ?></strong> no sistema do Curso Pastoral da Igreja Videira de Campinas site <strong><?php echo $site ?></strong>.</strong>
        </td>
    </tr>
    <tr>

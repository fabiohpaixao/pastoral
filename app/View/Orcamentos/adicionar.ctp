    ...
    <div class="col-lg-9">
        <section class="panel">
            <header class="panel-heading clearfix">
                <span class="pull-left"><i class="icon-plus"></i> <?php echo __('Adicionar Orçamento'); ?></span>
            ...
            <div class="col-lg-12">
                <section class="panel" >
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <section class="panel" >
                            <?php  echo $this->Form->input('Especialidade', array('multiple' => false)); ?>
                            </section>
                        </div>
                        <div class="col-lg-4">
                            <section class="panel" >
                        ...
                        <div class="col-lg-12">
                            <section class="panel" >
                               <header class="panel-heading"></header>
                                <div class="panel-body">
                                    <?php echo $this->Form->button('<i class="icon-plus"></i> Incluir', array('type' => 'button', 'id' => 'add-especialidade', 'class' => ' right btn btn-success btn-shadow', 'escape' => false)); ?>
                                </div>
                            </section>
                        </div>

                        <div class="col-lg-12">
                            <table class="table table-striped" id="table-especialidades">
                                <thead>
                                    <tr>
                                        <th>Especialidade</th>
                                        <th>Hora Normal</th>
...
<?php echo $this->Html->script('/js/page.orcamento', array('inline' => false)); ?> 
...
?>
<div class="row">
    <?php echo $this->Form->create('Professor', array('type' => 'file')); ?>
    <div class="col-lg-9">
        <section class="panel">
            <header class="panel-heading clearfix">
              <span class="pull-left"><i class="icon-plus"></i> <?php echo __('Adicionar Professor'); ?></span>
              ...
              <div class="panel-body">
                <?php
                    ...
                    echo $this->Form->input('rp', array('value' => $rp));

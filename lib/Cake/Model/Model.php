 ...
 */
	public function save($data = null, $validate = true, $fieldList = array()) {
		...
		if (empty($this->data) && !$this->hasField(array('criado', 'atualizado', 'modificado'))) {
			$this->whitelist = $_whitelist;
			return false;
		}

		foreach (array('criado', 'atualizado', 'modificado') as $field) {
			$keyPresentAndEmpty = (
		...
		$exists = $this->exists();
		$dateFields = array('modificado', 'atualizado');
